  ...
  _createClass(Table, [{
      ...
      if (typeof props.children !== "undefined") {
        _react2["default"].Children.forEach(props.children, (function (child) {
          ...
          switch (this.state.dev ? "" + child.type : child.type) {
            case this.state.dev ? "" + _thead.Thead : _thead.Thead:
              break;
            case this.state.dev ? "" + _tfoot.Tfoot : _tfoot.Tfoot:
              if (typeof tfoot !== "undefined") {
                console.warn("You can only have one <Tfoot>, but more than one was specified." + "Ignoring all but the last one");
              }
              tfoot = child;
              break;
            case this.state.dev ? "" + _tr.Tr : _tr.Tr:
    ...
    value: function render() {
      ...
      return _react2["default"].createElement(
        "table",
        props,
        this.state.dev && _react2["default"].createElement(
          "div",
          {
            style: {
              position: "fixed",
